...
module.exports = function PageController() {
    ...
    function setCurrentWeatherWrapper(operation) {
        ...
        if(operation === 'inactive') currentWeatherWrapper.classList.remove('active')
    }
    ...
    function setErrorMessage(operation) {
        ...
        if(operation === 'inactive') errorMessageElement.classList.remove('active')
    }
...
module.exports = function WeatherController() {
    ...
    const currentTemperature = document.querySelector(".temperature-current > span")
    const maximumTemperature = document.querySelector(".temperature-maximum > span")
    const minimumTemperature = document.querySelector(".temperature-minimum > span")
    ...
    const precipitation = document.querySelector(".conditions-group.precipitation span")
    ...
    const visibility = document.querySelector(".conditions-group.visibility span")
    
    function update(currentWeather, city) {
        cityElement.innerText = city
        currentTemperature.innerText = Math.round(Number(currentWeather.Temperature.Metric.Value))
        maximumTemperature.innerText = Math.round(Number(currentWeather.TemperatureSummary.Past12HourRange.Maximum.Metric.Value))
        minimumTemperature.innerText = Math.round(Number(currentWeather.TemperatureSummary.Past12HourRange.Minimum.Metric.Value))
        ...
        visibility.innerText = Math.round(Number(currentWeather.Visibility.Metric.Value))
    }
...
},{"../../env":5,"axios":6}],4:[function(require,module,exports){
const API_KEY = require("../../env")
const axios = require('axios')

module.exports = async function GetLocationKey(city) {
    // City Search API - https://developer.accuweather.com/accuweather-locations-api/apis/get/locations/v1/cities/search
    ...
    const cityResponse = response.data.find(cityResponse => cityResponse.LocalizedName.toLowerCase() === city) 
...
},{"../../env":5,"axios":6}],5:[function(require,module,exports){
module.exports = "qxePvCDXpe0c8rAmoBkr3J5rU8RW9q4O"
...
},{"./adapters/http":7,"./adapters/xhr":7,"./core/enhanceError":17,"./helpers/normalizeHeaderName":30,"./utils":34,"_process":35}],22:[function(require,module,exports){
module.exports = {
  "version": "0.24.0"
};
...
},{"../modules/PageController":1,"../modules/WeatherController":2,"../services/GetCurrentWeather":3,"../services/GetLocationKey":4}]},{},[36]);
